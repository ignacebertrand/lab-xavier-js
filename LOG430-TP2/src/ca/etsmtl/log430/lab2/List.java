...
/**
 * This is the base class that is used to construct the TeacherList and the
...
/* Modification Log
 **************************************************************************************
 * v1.4, M. Gingras, 2012-Feb-24 - Added size() function.
 *
...
public class List {
	 ...
	 * 
	 * @return int The number of elements contained
	 */
	public int size() {
