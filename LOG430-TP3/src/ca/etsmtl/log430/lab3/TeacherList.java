...
/**
 * Used by various other classes that need to keep a list of teachers on hand.
 * It extends the List class which provides the basic functionality for storage
 * and retrieval of the Teacher Object from the list.
 * 
...
public class TeacherList extends List {
	...
	/**
	 * @return The teacher at the current position pointed to by the internal
	 *         list pointer. Subsequent calls will return the next teacher
	 *         object in the list. A null object is returned if list is empty or
	...
	/**
	 * Determines whether the Teacher OBJ is currently in the list.
	 * 
	 * @param teacher
