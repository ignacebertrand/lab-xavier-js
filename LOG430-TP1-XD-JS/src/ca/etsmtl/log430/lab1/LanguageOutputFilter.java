...
public class LanguageOutputFilter extends Thread {
	...
	public LanguageOutputFilter(PipedWriter InputPipe, PipedWriter OutputPipe1, PipedWriter OutputPipe2) {
		...
		try {
			...
			System.out.println("LanguageOutputFilter:: connected to upstream filter.");

			// Connect OutputPipes

			this.OutputPipe1 = OutputPipe1;
			this.OutputPipe2 = OutputPipe2;
			System.out.println("LanguageOutputFilter:: connected to downstream filters.");

		} catch (Exception Error) {

			System.out.println("LanguageOutputFilter:: Error connecting to other filters.");
